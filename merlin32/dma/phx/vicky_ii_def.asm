...
BTX_END                 = $AFFFFF
	...
	put VKYII_CFP9553_BITMAP_def.asm
	put VKYII_CFP9553_TILEMAP_def.asm
	put VKYII_CFP9553_VDMA_def.asm
	put VKYII_CFP9553_SDMA_def.asm
	put VKYII_CFP9553_SPRITE_def.asm

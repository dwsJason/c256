...
sourcePtr  equ lzsa_sourcePtr
destPtr    equ lzsa_destPtr
matchPtr   equ lzsa_matchPtr
NIBBLE     equ lzsa_nibble
SUB_OFFSET equ lzsa_suboffset
TOKEN_WORD equ lzsa_token
